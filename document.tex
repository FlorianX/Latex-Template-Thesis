...
% Für erweiterte Tabellengestaltung 
\usepackage{array}

% Kopf und Fusszeilen gestalten
\usepackage{fancyhdr}

% URLs verlinken (für PDF)
\usepackage{url}
...
\newcommand{\PAGENUMBERS}[0]{Seite \pagemark \ von \pageref{EndOfContent}}
...
% Setze Numerierung wieder auf römisch zurück und setze von oben fort
\pagenumbering{Roman}
